  ...
  return (
    <div>
      ...
      <p>
        ...
        fetch call. This attributes allows server to share cookies or rather pass headers from initial page request
        (which includes cookies) to subsequent GraphQL requests.
      </p>
